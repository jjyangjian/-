...
- (void)updateDataWithArray:(NSArray *)dataArray;
{
    ...
    if (self.titleInfoArray.count > LABELCOUNT) {
        size.width = 80 + (self.titleInfoArray.count - 1) * ((SIZE.width - 80) / (LABELCOUNT - 1));
...
//        self.dataArray
    ...
    self.onlyHeaderView.backgroundColor = [UIColor colorWithRed:0.97f green:0.97f blue:0.97f alpha:1.00f];
