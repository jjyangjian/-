...
- (IBAction)topButtonClick:(UIButton *)sender {
    ...
    self.topButton0.selected = 0;
    self.topButton1.selected = 0;
    self.topButton2.selected = 0;
    self.topButton3.selected = 0;

    sender.selected = 1;
    
    [self switchSubControllerToIndex:sender.tag - 100 andCompletion:^(BOOL finished) {
        if (finished) {
            //            weakself.topButton0.selected = 0;
            //            weakself.topButton1.selected = 0;
            //            topButton.selected = 1;
